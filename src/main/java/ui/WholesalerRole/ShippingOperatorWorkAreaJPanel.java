...
/**
 * Main navigation screen for a Wholesaler Shipping Operator.
 */
public class ShippingOperatorWorkAreaJPanel extends JPanel {
    ...
    public ShippingOperatorWorkAreaJPanel(Enterprise enterprise) {
    ...
    private JPanel createHeader(Enterprise enterprise) {
        ...
        JLabel title = new JLabel("Shipping Operator - Work Area");
    ...
    private JPanel createPortal() {
        ...
        JLabel title = new JLabel("Shipping Operator Portal");
        ...
        addAction(actions, "Picking", 0, 0);
        addAction(actions, "Packing", 1, 0);
        addAction(actions, "Shipping", 0, 1);
        addAction(actions, "Receive Finished Goods", 1, 1);
        addAction(actions, "View Replenishment / Order Status", 0, 2);
        addAction(actions, "My Profile", 1, 2);
