...
/**
 * Main navigation screen for a Wholesaler Inventory Administrator.
 */
public class InventoryAdminWorkAreaJPanel extends JPanel {
    ...
    public InventoryAdminWorkAreaJPanel(UserAccount account, Enterprise enterprise) {
    ...
    private JPanel createHeader(Enterprise enterprise) {
        ...
        JLabel title = new JLabel("Inventory Administrator — Work Area");
    ...
    private JPanel createPortal() {
        ...
        JLabel title = new JLabel("Inventory Administrator Portal");
        ...
        addAction(actions, "Check Inventory", 0, 0);
        addAction(actions, "Create Replenishment Request", 1, 0);
        addAction(actions, "Check Another Wholesaler Inventory", 0, 1);
        addAction(actions, "Transfer Order Request", 1, 1);
        addAction(actions, "View Replenishment / Order Status", 0, 2);
        addAction(actions, "Manage Staff & Operator Account", 1, 2);
        addAction(actions, "Manage Admin Account", 0, 3);
