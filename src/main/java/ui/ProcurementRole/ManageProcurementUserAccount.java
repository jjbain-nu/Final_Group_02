 ...
 * @author raunak
 */
public class ManageProcurementUserAccount extends javax.swing.JPanel {
     ...
     */
    public ManageProcurementUserAccount(JPanel userProcessContainer, UserAccount account, ProcurementOrganization organization, Enterprise enterprise) {
        initComponents();
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        CreateProcurementUserAccount cua = new CreateProcurementUserAccount(userProcessContainer, userAccount,organization,enterprise);
        userProcessContainer.add("CreateProcurementUserAccount",cua);
    ...
    public void populateUserAccountTable() {
       DefaultTableModel model = (DefaultTableModel) tblUserAccount.getModel();
        ...
        for (Organization org : enterprise.getOrganizationDirectory().getOrganizationList()){
            ...
            if(ua.getRole() instanceof ProcurementRole){
